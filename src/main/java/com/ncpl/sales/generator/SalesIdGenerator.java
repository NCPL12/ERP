...
public class SalesIdGenerator extends SequenceStyleGenerator{
    ...
    public Serializable generate(SharedSessionContractImplementor session,
    	 ...
    	 * returning the salesorder id with appended values..
    	 */
    	//SalesOrder salesorder = (SalesOrder) object;
    	String city = "BLR";
    	String abbrivation = "ELT";
    	int year = Calendar.getInstance().get(Calendar.YEAR);
    	String s = valuePrefix + "-" + city + "-" + abbrivation + "-" + String.format(numberFormat, super.generate(session, object)) +"-" + year;
