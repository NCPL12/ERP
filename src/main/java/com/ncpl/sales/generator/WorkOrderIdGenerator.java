...
public class WorkOrderIdGenerator  extends SequenceStyleGenerator{
    ...
    public Serializable generate(SharedSessionContractImplementor session,
    	...
    	String s = valuePrefix + "-" + city + "-"  + String.format(numberFormat, super.generate(session, object)) +"-" + year;
