...
<script type="text/javascript">
 ...
 <script src="<c:url value="/resources/js/nonBillable.js" />"></script> 
<script src="<c:url value="/resources/js/pageHeader.js" />"></script>
<script src="${RESOURCES}js/common.js" ></script>
<script type="text/javascript">
var nonBillableList =${nonBillableList};
</script>
<style>
#purchaseDiv{
	height: 400px;
}
#nonBillableTable>tbody>tr>td,  #nonBillableTable>thead>tr>th {
...
<body class="hold-transition sidebar-mini">
	<div class="wrapper">
		...
		<form id="nonBillableForm" method="POST"  action="">
    
			<div id="salesDiv" class="card">
			<div class="card-body table-responsive p-0">
				<table id="nonBillableTable" class="table table-head-fixed" style="width: 100%;">
					<thead id="table-header">
						<tr>
							<th width="5%" style="position:inherit;">Sl.No</th>
							<th width="40%" style="position:inherit;">Description</th>
							<th width="10%" style="position:inherit;">Model No</th>
							<th width="10%" style="position:inherit;">HSN</th>
							<th width="7%" style="position:inherit;">Qty</th>
        ...
        <div class="button-div-style" id="buttonDiv" align="center">
			<button  type="submit" id="saveNonBillable"class="btn btn-primary btn-sm btn-inline"> Save Indent
				</button>
		      </div>
			</div>
			</form>
