...
<script src="<c:url value="/resources/js/outstandingStock.js" />"></script>
<%-- <script src="<c:url value="resources/js/oustandingStock.js" />"></script> --%>
<script>
var outstandingStockList=${outstandingStockList};
		...
		<div class="content-wrapper">
			...
			<div id="salesDiv" class="card">
				<div class="card-body" style="padding-top: 10px;">
					<table id="oustandingStockList" class="table table-bordered table-striped partyListTable">
						<tbody>
						</tbody>
					</table>
				</div>
