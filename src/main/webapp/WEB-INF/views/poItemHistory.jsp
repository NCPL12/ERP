...
<script src="<c:url value="/resources/js/poItemHistory.js" />"></script>
<link rel="stylesheet"
	href="//code.jquery.com/ui/1.12.1/themes/base/jquery-ui.css">
<script src="https://code.jquery.com/ui/1.12.1/jquery-ui.js"></script>
<%-- <script src="<c:url value="resources/js/oustandingStock.js" />"></script> --%>
<script>
var poItemHistoryList=${poItemHistoryList};
		...
		<div class="content-wrapper">
			...
			<div id="salesDiv" class="card">
				<div class="card-body" style="padding-top: 10px;">
					<table id="poItemHistoryTable" class="table table-bordered table-striped partyListTable">
						<tbody>
						</tbody>
					</table>
				</div>
