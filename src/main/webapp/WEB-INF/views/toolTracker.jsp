...
<body class="hold-transition sidebar-mini">
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<form:form id="itemMasterForm1" method="POST"
				modelAttribute="itemMaster"
				...
				<div id="salesDiv" class="card">
					<div class="container">
						 <div class="row" style="padding: 10px;">
    						<label for="itemModelNo" class="col-form-label form-control-sm col-sm-1">Model No</label>
   								 <div class="col-sm-2">
     								 <input type="text" name="model" id="itemModelNo" class="form-control form-control-sm">
   						 	...
   						 	<label for="itemDescription" class="col-form-label form-control-sm col-sm-1.5">Description</label>
   								 <div class="col-sm-4">
     								 <input type="text" name="itemName"  id="itemDescription" class="form-control form-control-sm">
 						 ...
 						 <label for="units" class="col-form-label form-control-sm col-sm-1">Units</label>
   						 		...
   						 		<label for="units" class="col-form-label form-control-sm col-sm-1">Make</label>
   						 		 <div class="col-sm-2">
     								 <select name="make" id="makeDropdown"  class="form-control form-control-sm select2">
     								 <option value="" selected>Not selected</option>
     								 </select>
     								 <div>
 						...
 						<div class="row" style="padding: 10px;">
 						 		<label for="toolsTracker" class="col-form-label form-control-sm col-sm-2">Tools & Trackers</label>
   						 		<div class="col-sm-2">
     								 <input style="width: 10%;" type="checkbox"
											value="" name="toolTracker" id="toolTracker" class="form-control form-control-sm" />
     								 <div id="toolsTrackerDiv"></div>
   						 		</div>
   						 		<label for="companyAssets" class="col-form-label form-control-sm col-sm-1">Company Assets</label>
   						 		<div class="col-sm-2">
     								 <input style="width: 10%;" type="checkbox"
											value="" name="companyAssets" id="companyAssets" class="form-control form-control-sm" />
     								 <div id="companyAssetsDiv"></div>
   						 		</div>
   						 		 <label for="quantity" class="col-form-label form-control-sm col-sm-1 hideInput">Quantity</label>
   								 <div class="col-sm-2">
     								<input type="text"  id="stockQuantity" class="form-control form-control-sm hideInput" readonly />
   						 		</div>
   						 		 <label for="costPrice" class="col-form-label form-control-sm col-sm-1 hideInput">Cost Price</label>
   								 <div class="col-sm-2">
     								<input type="text"  id="supplierCostPrice" class="form-control form-control-sm hideInput" readonly />
   						 		</div>
					...
					<div class="button-div-style" align="center">
						...
						<button type="button" id="cncl" class="btn btn-primary btn-sm btn-inline">Cancel
						</button>
					</div>
				</div>
			</form:form>
	...
	<!--.stock modal-dialog -->
				...
				<div class="modal-dialog" role="document">
					<div class="modal-content" style="width:800px">
						...
						<h4 class="modal-title" id="stockHeader">Add Stock </h4>
							<button type="button" class="close buttonDismiss" id="stockReset" data-dismiss="modal"
				...
				<div class="row">		
						...
						<div class="modal-body no-padding" style="margin-top: 0px !important;">
						
						<div class="container">
						 <div class="row" style="padding: 10px;">
    						<label for="itemModelNo" class="col-form-label form-control-sm col-sm-3">Client</label>
   								 <div class="col-sm-8">
     								 <select name="stockclientName" id="stockclientName" class="form-control form-control-sm select2" >
     								 <!-- <option value="" selected>Not selected</option>  -->
     								 </select>
   						 		 ...
   						 		 <div class="row" style="padding: 10px;">
   						 		<label for="itemHSNCode" class="col-form-label form-control-sm col-sm-3" style="padding-left: 7px;">Quantity</label>
   								 <div class="col-sm-4">
     								 <input type="text" name="stockClientquantity"  id="stockClientquantity"class="form-control form-control-sm"  data-msg="Quantity is required" required readonly>
   						 		</div>
   						 		<div id="qtyunits"></div>
   						 	
 						 </div>
 						 <div class="row" style="padding: 10px;">
 						<label for="itemDescription" class="col-form-label form-control-sm col-sm-3">Store</label>
   								 <div class="col-sm-8">
     								 <input type="text" name="stockstoreName" id="stockstoreName" class="form-control form-control-sm" data-msg="Store Name is required" required readonly>
   						 	</div>
   						 	</div>
   						 	 <div class="row" style="padding: 10px;">
    						<label for="itemDescription" class="col-form-label form-control-sm col-sm-3" style="padding-left: 7px;">Location</label>
   								 <div class="col-sm-8">
     								 <input type="text" name="stocklocationInStore" id="stocklocationInStore" class="form-control form-control-sm" readonly>
   						 	</div>
 						 </div>
					...
					<form class="form" id="stockModelForm">
						...
						<div class="container">
						 <div class="row" style="padding: 10px;">
    						<label for="itemModelNo" class="col-form-label form-control-sm col-sm-3">Client</label>
   								 <div class="col-sm-8">
     								 <select name="clientName" id="clientName" class="form-control form-control-sm select2"  >
     								 <option value="" selected>Not selected</option>
     								 </select>
   						 		...
   						 		<label for="itemHSNCode" class="col-form-label form-control-sm col-sm-3" style="padding-left: 7px;">Quantity</label>
   								 <div class="col-sm-4">
     								 <input type="text" name="quantity"  id="quantity"class="form-control form-control-sm" data-msg="Quantity is required" required>
   						 		</div>
 						...
 						<label for="itemDescription" class="col-form-label form-control-sm col-sm-3">Store</label>
   								 <div class="col-sm-8">
     								 <input type="text" name="storeName" id="storeName" class="form-control form-control-sm" data-msg="Store Name is required" required>
   						 	</div>
   						 	</div>
   						 	 <div class="row" style="padding: 10px;">
    						<label for="itemDescription" class="col-form-label form-control-sm col-sm-3" style="padding-left: 7px;">Location</label>
   								 <div class="col-sm-8">
     								 <input type="text" name="locationInStore" id="locationInStore" class="form-control form-control-sm">
   						 	</div>
 						 </div>
								...
								<button type="button" class="btn btn-primary btn-sm btn-inline buttonDismiss" data-dismiss="modal" id="resetBtn">Cancel
									</button>
				...
				<div class="modal-dialog" role="document">
					<div class="modal-content" style="width:800px">
						...
						<h4 class="modal-title" id="supplierHeader">Map Supplier</h4>
							<button type="button" class="close buttonDismiss" id="supplierReset" data-dismiss="modal"
								aria-label="Close" style="outline: none;">
								<span aria-hidden="true" >&times;</span>
						...
						<div class="container">
						 	<div class="row" style="padding: 10px;">
    						<label for="supplierName" class="col-form-label form-control-sm col-sm-1">Supplier</label>
   								 <div class="col-sm-5">
     								 <select name="supplierName" id="supplierName" class="form-control form-control-sm select2">
     								 <option value="" selected>Not selected</option>
									  </select>
									  <div id="supplierErrorDiv"></div>
   						 		</div>
   						 		
   						 		<label for="costPrice" class="col-form-label form-control-sm col-sm-2" style="padding-left: 37px;">Cost Price</label>
   								 <div class="col-sm-2">
     								 <input type="text" name="costPrice"  id="costPrice" class="form-control form-control-sm" required data-msg="Cost Price is required">
   						 		</div>
   						 		<label for="preferred" class="col-form-label form-control-sm col-sm-1" >Preferred</label>
   								 <div class="col-sm-1" style="text-align: center;">
     								 <input type="radio" name="preferred" id="preferred" class="form-control-sm" >
   						 		</div>
 						 	</div>
 						 </div>
								...
								<div class="button-div-style" align="center">
									...
									<button type="reset" class="btn btn-primary btn-sm btn-inline" id="resetSupplierBtn">Reset
									</button>
								</div>
			...
			<div class="modal-content" style="width: 520px;">
				...
				<form class="form" id="makeForm">
					...
					<div class="modal-body">
						<table id="makeTable" class="makeTable table table-bordered table-striped">
						</table>
					...
					<div class="modal-footer footerDivinType">
						...
						<button type="reset" class="btn btn-primary" id="makeResetBtn">Cancel</button>
